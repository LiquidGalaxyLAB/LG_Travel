class NationModel {
  ...
  static List<NationModel> getNations() {
    ...
    nations.add(NationModel(
      ...
      description:
          "Straight from the streets of Chandani Chowk in Delhi to  Brampton Canada, as best indian restaurant we take pride in bringing Paranthas in a way no one could imagine with hundreds of variations in Vegetarian, Non Vegetarian, Pizza fusion blends and Sweet flavours sure to entice one and all in your family. With four locations in Brampton, Niagara Falls & Kitchener and growing.Now relish Home Taste Away From Home\n\n The chief ingredient in our food is love. There is no better reward for hard work than good food. And we customize love, happiness, hard work and our freshest ingredients to your complete satisfaction. Spiced with love and served with enthusiasm, the taste your family will relish for days.",
    ...
    nations.add(NationModel(
      ...
      description:
          "The Cornetto e Caffè, an Italian breakfast classic, unfolds as a delightful symphony of simplicity and indulgence. Imagine a golden, flaky cornetto, akin to a croissant but with a uniquely Italian touch, boasting layers that shatter delicately upon each bite. This pastry perfection is accompanied by the rich aroma of freshly brewed espresso, creating a harmonious pairing that epitomizes the essence of Italian mornings. \n\nThe cornetto, either plain or filled with luscious cream or fruity jam, exudes a sweet fragrance that mingles with the robust notes of the coffee. The ritual of dipping the tip of the cornetto into the espresso is a sensory experience, where the warm, buttery layers meet the bold intensity of the coffee. This breakfast, enjoyed amidst the lively ambiance of an Italian café, represents a moment of pure indulgence and a celebration of the country's rich culinary heritage.",
    ...
    nations.add(NationModel(
      ...
      description:
          "Pa amb Tomàquet, a cherished Catalan dish, transforms the act of bread into an artful expression of simplicity and flavor. This Catalan tomato bread consists of rustic, crusty bread slices rubbed with ripe tomatoes, imparting a burst of freshness.\n\n The process of grating the tomatoes releases their juices, creating a vibrant and moist base for the bread.  Often seasoned with a pinch of salt and sometimes garlic, the Pa amb Tomàquet is a celebration of quality ingredients. The combination of the sweet acidity from the tomatoes, the richness of the olive oil, and the earthy bread creates a harmonious medley that captures the essence of Catalan cuisine. Served as a standalone delight or as an accompaniment to various dishes, Pa amb Tomàquet embodies the culinary philosophy of simplicity, letting the natural flavors shine through with each bite.",
